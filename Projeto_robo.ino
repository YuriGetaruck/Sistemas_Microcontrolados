...
void perna1(){
  ...
  for(int i = 0; i < 180; i++){
    ...
    //angmotor1 = angmotor1 - 90;
    //angmotor2 = angmotor2 - 90;
...
void anda(){
  ...
  for(int i = 0; i < 180; i++){
    ...
    double theta2rad = acos((x*x+y*y-L1*L1-L2*L2)/(2*L1*L2));
    double theta1rad = atan(y/x)-atan(L2*sin(theta2rad)/(L1+L2*cos(theta2rad)));// 1 e 3


    double theta4rad = acos((x1*x1+y1*y1-L1*L1-L2*L2)/(2*L1*L2));
    double theta3rad = atan(y1/x1)-atan(L2*sin(theta2rad)/(L1+L2*cos(theta2rad)));// 2 e 4

    
    double angmotor1 = 90-(theta1rad*180/3.14); //1 e 3
    double angmotor2 = 90-(theta2rad*180/3.14); //1 e 3
    double angmotor3 = 90+(theta3rad*180/3.14); //2 e 4
    double angmotor4 = 90+(theta4rad*180/3.14); //2 e 4
    ...
    long double posmotor1 = (angmotor1 * 100/9) + 1500;
    long double posmotor2 = (angmotor2 * 100/9) + 1500;
    long double posmotor3 = (angmotor3 * 100/9) + 1500;
    long double posmotor4 = (angmotor4 * 100/9) + 1500;
